"""MorphSQL CLI — `morphsql` command-line interface."""
...
def convert(
    ...
    from morphsql.dbt_generator.decomposer import (
        decompose_to_dbt,
        format_dbt_project,
        is_dbt_target,
        write_dbt_project,
    ...
    if path_obj.is_file():
        ...
        if generate_lineage:
            from morphsql.lineage import build_lineage_graph, format_lineage_tree

...
<title>MorphSQL Report — {{ report.repository_path }}</title>
<style>
  :root {
...
<body>
<div class="container">
  <h1>MorphSQL Migration Report</h1>
  ...
  <div class="footer">
    Generated by <strong>MorphSQL</strong> | Open-source SQL migration toolkit
  </div>
</div>
</body>
</html>"""
